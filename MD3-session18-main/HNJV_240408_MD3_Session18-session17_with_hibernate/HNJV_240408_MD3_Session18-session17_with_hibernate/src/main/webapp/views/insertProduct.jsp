...
<div class="container">
    ...
    <form:form modelAttribute="p" action="insertProduct" method="post" enctype="multipart/form-data">
        <table class="table table-bordered">
            ...
            <tr>
                <td>Expire Date:</td>
                <td><form:input type="date" path="expireDate"/>
                    <br/><form:errors path="expireDate" cssClass="text-danger"/></td>
            </tr>
            <tr>
                <td>Price:</td>
                <td><form:input type="number" path="price"/>
                    <br/><form:errors path="price" cssClass="text-danger"/></td>
            </tr>
            <tr>
                <td>Unit price:</td>
                <td><form:radiobutton path="unitPrice" value="USD"/>USD
                    <form:radiobutton path="unitPrice" value="VND"/>VND
                    <br/><form:errors path="unitPrice" cssClass="text-danger"/></td>
            </tr>
            <tr>
                <td>Color:</td>
                <td><form:checkbox path="color" value="Red"/>Red
                    <form:checkbox path="color" value="Green"/>Green
                    <form:checkbox path="color" value="Blue"/>Blue
                    <form:checkbox path="color" value="Yellow"/>Yellow
                    <br/><form:errors path="color" cssClass="text-danger"/>
                </td>
            </tr>
            <tr>
                <td>Primary Image: </td>
